...
JWT_AUTH = {
    'JWT_ENCODE_HANDLER':
        'app.auth_login.auth.jwt_encode_handler',

    'JWT_DECODE_HANDLER':
        'app.auth_login.auth.jwt_decode_handler',

    'JWT_PAYLOAD_HANDLER':
        'app.auth_login.auth.jwt_payload_handler',

    'JWT_PAYLOAD_GET_USER_ID_HANDLER':
        'rest_framework_jwt.utils.jwt_get_user_id_from_payload_ha ndler',

    'JWT_RESPONSE_PAYLOAD_HANDLER':
        'app.auth_login.auth.jwt_response_payload_handler',

    'JWT_SECRET_KEY': 'It{>Gd}o;pK-?E.I=v{S&x8=YBbC:/(Bgg?CV.btQY>;eN&rbC?B$C|P7Lq#51j!N$oC(LeHuVO]]cQKfXNyh|8q>jUqeIe!\_0)12+v2=Ph3/FOw4xL',
    'JWT_ALGORITHM': 'HS256',
    'JWT_VERIFY': True,
